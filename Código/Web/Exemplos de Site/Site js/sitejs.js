...
function hoje() {
	...
	document.form.data.value=datahj;
...
function valida(){
	...
	if(document.form.nome.value==""){
		alert("Não se esqueça do nome.")
		saida = false;
	}
	if(document.form.email.value==""){
		alert("Não se esqueça do e-mail.")
		saida = false;
	}
	if(document.form.cpf.value==""){
		alert("Não se esqueça do cpf.")
		saida = false;
	}
	if(document.form.theDate2.value==""){
		alert("Não se esqueça da data de nascimento.")
		saida = false;
	}

	if(document.form.cidade.value==""){
		alert("Não se esqueça do nome da sua Cidade.")
		saida = false;
	}

	if(document.form.uf.value=="-1"){
		alert("Não se esqueça de informar seu Estado.")
		saida = false;
	}
	if(document.form.comentario.value==""){
		alert("Não se esqueça da sua mensagem.")
		saida = false;
	}
	if(document.form.check.checked==false){
		alert("Não se esqueça de conferir seus dados antes de enviar.")
		saida = false;
	}
